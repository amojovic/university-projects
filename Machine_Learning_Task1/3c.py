...
x = data[['sepal_length', 'sepal_width', 'petal_length', 'petal_width']].values  # sada sve uzimamo
...
# diskusija ---
# kada smo u program ukljucili sva 4 featura, accuracy na test skupu je porastao u poredjenju sa prethodnim koji je koristio samo prve dve osobine
# u nekim slucajevima, accuracy je dostigao 100%
# ovo verovatno znaci da je overfitovano, model previse precizno prati dataset te ne moze da generalizuje
